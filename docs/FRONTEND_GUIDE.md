...
1. **Start with:** `axios.js` - Understand HTTP requests
2. **Then:** `AuthContext.jsx` - Learn React Context & state management
3. **Next:** `Login.jsx` - See form handling & authentication flow
